                ...
                if (!clientConnect) { // set up clients first
                    for (int id : peerInfoMap.keySet()) {
                        ...
                        if (id < myPeerID) {
                            ...
                            new Handler(requestSocket, myPeerID).start();
    ...
    static class Handler extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                if (isOwner == 0) { // if not owner, request the first piece
                ...
                while (this.din.read(messageLength) > 0) {

                    this.din.read(messageType);

                    if (Arrays.equals(messageType, messageTypeMap.get("request"))) {
                        System.out.println(myPeerID + " received request message from " +
