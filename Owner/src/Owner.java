    ...
    private static class Server extends Thread {
        ...
        public void run() {
            try {
                ...
                objectOutputStream.writeObject(path); //Sending file path to peers
                objectOutputStream.writeObject(Integer.toString(chunks.size())); //Sending number of chunks to peers
